...
enum Addressing {Immediate =0, Direct =1, Relative =2 , Register =3 ,Error = -1};
...
#define SET_COMMAND_TABLE(x) CMD x[16];\
  ...
  x[6].opcode=5; x[6].funct=11; x[6].operands=1; strcpy(x[5].opSrc , "0"); strcpy(x[5].opDest ,"13");strcpy(x[6].command , "not");\
  x[5].opcode=5; x[5].funct=10; x[5].operands=1; strcpy(x[6].opSrc ,"0"); strcpy(x[6].opDest ,"13");strcpy(x[5].command , "clr");\
  x[7].opcode=5; x[7].funct=12; x[7].operands=1; strcpy(x[7].opSrc, "0"); strcpy(x[7].opDest ,"13"); strcpy(x[7].command , "inc");\
  x[8].opcode=5; x[8].funct=13; x[8].operands=1; strcpy(x[8].opSrc ,"0"); strcpy(x[8].opDest ,"13");strcpy(x[8].command , "dec");\
  x[9].opcode=9; x[9].funct=10; x[9].operands=1; strcpy(x[9].opSrc ,"0"); strcpy(x[9].opDest ,"12");strcpy(x[9].command , "jmp");\
  x[10].opcode=9; x[10].funct=11; x[10].operands=1;strcpy(x[10].opSrc ,"0"); strcpy(x[10].opDest ,"12"); strcpy(x[10].command , "bne");\
  x[11].opcode=9; x[11].funct=12; x[11].operands=1; strcpy(x[11].opSrc ,"0"); strcpy(x[11].opDest ,"12");strcpy(x[11].command , "jsr");\
  x[12].opcode=12; x[12].funct=0; x[12].operands=1; strcpy(x[12].opSrc, "0"); strcpy(x[12].opDest ,"13");strcpy(x[12].command , "red");\
  x[13].opcode=13; x[13].funct=0; x[13].operands=1; strcpy(x[13].opSrc, "0"); strcpy(x[13].opDest ,"013");strcpy(x[13].command , "prn");\
  x[14].opcode=14;x[14].funct=0; x[14].operands=0; strcpy(x[14].opSrc ,"0"); strcpy(x[14].opDest,"0");strcpy(x[14].command , "rts");\
  x[15].opcode=15; x[15].funct=0; x[15].operands=0; strcpy(x[15].opSrc,"0"); strcpy(x[15].opDest,"0");strcpy(x[15].command , "stop");
